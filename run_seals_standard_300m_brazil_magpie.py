...
if __name__ == '__main__':
    ...
    p.project_name = 'Brazil_magpie_npi_300m'
    # + hb.pretty_time()
    ...
    p.scenario_definitions_filename = 'scenarios_BRA_magpie_mapbiomas_NPI_300m_global_coefs_working.csv'  
    ...
    p.processing_resolution = 1 # In degrees. Must be in pyramid_compatible_resolutions
