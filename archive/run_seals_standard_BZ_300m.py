...
if __name__ == '__main__':
    ...
    p.project_name = 'Brazil_magpie_mapbiomas_policy6_300m_3_25_26'
    ...
    aoi = gpd.read_file(os.path.join(p.base_data_dir, 'cartographic/ee/aoi_BRA_clipped_forreal.gpkg'))
    ...
    p.base_data_dir = os.path.join(p.user_dir, 'base_data')
