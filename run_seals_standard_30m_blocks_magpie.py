...
if __name__ == '__main__':
    ...
    for block in ['468_372']:       
        ...
        p.project_name = 'Brazil_magpie_NPI_' + block + '_magpie_landclasses_fixed_' + hb.pretty_time() 
        ...
        block_aoi = gpd.read_file(os.path.join(p.user_dir, 'Files/base_data/cartographic/ee/block_' + block + '.gpkg'))
        ...
        p.scenario_definitions_filename = 'scenarios_BRA_magpie_mapbiomas_NPI_30m_global_coefs_working.csv'
        ...
        p.processing_resolution = 0.5 # In degrees. Must be in pyramid_compatible_resolutions
