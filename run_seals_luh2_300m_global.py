...
if __name__ == '__main__':
    ...
    p.project_name = 'luh2_300m_global_v02'
    ...
    p.scenario_definitions_filename = 'standard_scenarios_BRA_magpie_mapbiomas_policy6_300m.csv'  # ERK - didn't look right
    # p.scenario_definitions_filename = 'seals/default_inputs/standard_scenarios.csv'
    p.scenario_definitions_path = os.path.join(p.input_dir, p.scenario_definitions_filename)
    # p.scenario_definitions_path = os.path.join(p.base_data_dir, p.scenario_definitions_filename)
