...
reportLandUseForSEALS(
  magCellLand = file.path(outputdir, "cell.land_0.5.mz"),
  outFile = file.path(outputdir, paste0("cell.land_0.5_SEALS_", title, ".nc")),
  selectyears = c(2020, 2030, 2040, 2050)
)
...
if (plantation) {
  land_hr <- read.magpie(file.path(outputdir, "cell.land_0.5.mz"))
  land_hr[, , "forestry"] <- 0
