...
if __name__ == '__main__':
    ...
    p.project_name = 'Brazil_magpie_mapbiomas_policy6_30m_12_15_25'
    ...
    aoi = gpd.read_file(os.path.join(p.ext_drive, 'base_data/cartographic/ee/aoi_BRA_clipped_forreal.gpkg'))
    aoi.to_file(os.path.join(p.project_dir, 'intermediate/project_aoi/aoi_BRA_clipped_forreal.gpkg'), driver='GPKG') 
