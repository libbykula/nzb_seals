...
if __name__ == '__main__':
    ...
    for i in [11]:     
        ...
        p.project_name = 'Brazil_magpie_npi_' + str(i) + hb.pretty_time()
        ...
        p.scenario_definitions_filename = 'scenarios_BRA_magpie_mapbiomas_NPI_30m_global_coefs_working.csv'  # no 
