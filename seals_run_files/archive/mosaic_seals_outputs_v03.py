...
for year in [2050]:
    ...
    for i in range(0, 12):        
        ...
        p.project_name = 'Brazil_magpie_mapbiomas_policy6_30m_3600s_coefs_no_pa_' + str(i)
    ...
    output_path = os.path.join(p.user_dir, os.sep.join(p.extra_dirs), 'lulc_mapbiomas_seals7_ssp5_rcp85_luh2-magpie_bau_' + str(year) + '_1deg_clipped_mosaic_no_pa.tif')
