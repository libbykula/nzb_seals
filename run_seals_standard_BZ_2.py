...
if __name__ == '__main__':
    ...
    p.project_name = 'Brazil_magpie_mapbiomas_policy6_30m_11_18_2025'
    ...
    p.scenario_definitions_filename = 'standard_scenarios_BRA_magpie_mapbiomas_policy6_30m_hb_pyr.csv' 
