...
if __name__ == '__main__':
    ...
    p.project_name = 'Brazil_magpie_mapbiomas_policy6_3600s_block_117_93'
    ...
    p.scenario_definitions_filename = 'standard_scenarios_BRA_magpie_mapbiomas_policy6_30m_block_117_93.csv' 
